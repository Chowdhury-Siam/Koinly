...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1178+222'));
    expect(config, contains("defaultValue: '1.0.1178'"));
    expect(androidGradle, contains('versionCode = 222'));
    expect(androidGradle, contains('versionName = "1.0.1178"'));
