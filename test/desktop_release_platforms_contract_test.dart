...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1186+230'));
    expect(config, contains("defaultValue: '1.0.1186'"));
    expect(androidGradle, contains('versionCode = 230'));
    expect(androidGradle, contains('versionName = "1.0.1186"'));
