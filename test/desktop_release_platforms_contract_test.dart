...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1180+224'));
    expect(config, contains("defaultValue: '1.0.1180'"));
    expect(androidGradle, contains('versionCode = 224'));
    expect(androidGradle, contains('versionName = "1.0.1180"'));
