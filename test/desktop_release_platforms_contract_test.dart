...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1165+209'));
    expect(config, contains("defaultValue: '1.0.1165'"));
    expect(androidGradle, contains('versionCode = 209'));
    expect(androidGradle, contains('versionName = "1.0.1165"'));
