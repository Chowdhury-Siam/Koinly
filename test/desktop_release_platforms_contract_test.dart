...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1191+235'));
    expect(config, contains("defaultValue: '1.0.1191'"));
    expect(androidGradle, contains('versionCode = 235'));
    expect(androidGradle, contains('versionName = "1.0.1191"'));
