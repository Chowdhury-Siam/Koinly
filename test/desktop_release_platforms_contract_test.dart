...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1163+207'));
    expect(config, contains("defaultValue: '1.0.1163'"));
    expect(androidGradle, contains('versionCode = 207'));
    expect(androidGradle, contains('versionName = "1.0.1163"'));
