...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1168+212'));
    expect(config, contains("defaultValue: '1.0.1168'"));
    expect(androidGradle, contains('versionCode = 212'));
    expect(androidGradle, contains('versionName = "1.0.1168"'));
