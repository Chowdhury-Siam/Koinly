...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1190+234'));
    expect(config, contains("defaultValue: '1.0.1190'"));
    expect(androidGradle, contains('versionCode = 234'));
    expect(androidGradle, contains('versionName = "1.0.1190"'));
