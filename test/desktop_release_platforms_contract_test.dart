...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1169+213'));
    expect(config, contains("defaultValue: '1.0.1169'"));
    expect(androidGradle, contains('versionCode = 213'));
    expect(androidGradle, contains('versionName = "1.0.1169"'));
