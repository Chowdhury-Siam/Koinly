...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1162+206'));
    expect(config, contains("defaultValue: '1.0.1162'"));
    expect(androidGradle, contains('versionCode = 206'));
    expect(androidGradle, contains('versionName = "1.0.1162"'));
