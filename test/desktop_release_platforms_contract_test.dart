...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1174+218'));
    expect(config, contains("defaultValue: '1.0.1174'"));
    expect(androidGradle, contains('versionCode = 218'));
    expect(androidGradle, contains('versionName = "1.0.1174"'));
