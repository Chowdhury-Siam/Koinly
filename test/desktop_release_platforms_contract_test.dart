...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1188+232'));
    expect(config, contains("defaultValue: '1.0.1188'"));
    expect(androidGradle, contains('versionCode = 232'));
    expect(androidGradle, contains('versionName = "1.0.1188"'));
