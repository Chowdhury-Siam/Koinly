...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1189+233'));
    expect(config, contains("defaultValue: '1.0.1189'"));
    expect(androidGradle, contains('versionCode = 233'));
    expect(androidGradle, contains('versionName = "1.0.1189"'));
