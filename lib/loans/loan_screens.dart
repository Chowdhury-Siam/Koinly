        ...
        itemBuilder: (context, index) {
          ...
          if (item is _LoanContactGroup) {
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: Text(item.contact.name, style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600))),
                  Text(_signedLoanAmount(state, net), style: const TextStyle(color: kSleekMuted, fontWeight: FontWeight.w600)),
                ],
              ),
            );
          }
...
class _LoanSummaryHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ExpressiveCard(
      color: Theme.of(context).brightness == Brightness.dark ? const Color(0xFF191215) : null,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Row(
            children: [
              Expanded(child: Text('Portfolio', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600))),
              if (summary.overdueCount > 0)
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                  decoration: BoxDecoration(color: kSleekWarning.withOpacity(.14), borderRadius: BorderRadius.circular(999)),
                  child: Text('${summary.overdueCount} overdue', style: const TextStyle(color: kSleekWarning, fontWeight: FontWeight.w600)),
                ),
            ],
          ),
          const SizedBox(height: 14),
    ...
    return Semantics(
      ...
      child: ExpressiveCard(
        ...
        child: ListTile(
          ...
          title: Text(contact?.name ?? 'Unknown person', style: const TextStyle(fontWeight: FontWeight.w600)),
          subtitle: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodySmall?.copyWith(color: computation.overdue ? kSleekWarning : kSleekMuted, fontWeight: FontWeight.w500),
              ),
          ...
          trailing: Column(
            ...
            children: [
              Text(state.format(loanNonNegative(computation.outstanding)), style: TextStyle(color: accent, fontWeight: FontWeight.w600)),
        ...
        itemBuilder: (context, index) {
          ...
          return ExpressiveCard(
            ...
            child: ListTile(
              ...
              title: Text(state.format(payment.amount), style: const TextStyle(fontWeight: FontWeight.w600)),
              subtitle: Text(
    ...
    return ExpressiveCard(
      child: Column(
        ...
        children: [
          ...
          Text(state.format(loanNonNegative(computation.outstanding)), style: Theme.of(context).textTheme.displaySmall?.copyWith(color: color, fontWeight: FontWeight.w600)),
          const SizedBox(height: 6),
