    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text(editing ? 'Edit loan' : 'New loan', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700))),
          ...
          if (emi != null) ...[
            ...
            Text('Estimated monthly payment: ${state.format(emi)}', style: const TextStyle(color: kSleekAccent, fontWeight: FontWeight.w700)),
          ],
          const SizedBox(height: 10),
          SwitchListTile(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text('Record payment', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700))),
              IconButton(onPressed: busy ? null : () => Navigator.pop(context), icon: const Icon(Icons.close_rounded)),
            ],
          ),
          const SizedBox(height: 8),
          Text('Remaining ${state.format(remaining)}', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: kSleekAccent, fontWeight: FontWeight.w700)),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text('Loan preferences', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700))),
